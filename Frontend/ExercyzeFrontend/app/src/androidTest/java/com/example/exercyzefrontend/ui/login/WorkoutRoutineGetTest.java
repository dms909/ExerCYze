...
public class WorkoutRoutineGetTest {

    @Rule
    public ActivityTestRule<LoginActivity> mActivityTestRule = new ActivityTestRule<>(LoginActivity.class);

    @Test
    public void workoutRoutineGetTest() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.list_content), withText("Lower Body "),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id.list_content), withText("Upper Body"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.userRoutineList),
                                        1),
                                0),
                        isDisplayed()));
        textView2.check(matches(withText("Upper Body")));
    }
