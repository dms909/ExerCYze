...
/**
 * class that handles with sign up activty page on app
 */
public class SignUpActivity extends AppCompatActivity implements Validator.ValidationListener {
    ...
    // showing of the intital view of the text sign up fields
    private void initView() {
        ...
        signUpButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // validating height and weight for invalid input
                validator.validate();
                if (height == 0.0) {
                    validated = false;
                ...
                if (validated) {
                    // once validated then login activty and model gets user's data
